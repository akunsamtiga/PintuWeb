...
export default function Pricing() {
  ...
  return (
    <section className="py-20 md:py-24 px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-white rounded-full border border-gray-200">
            ...
            <span className="text-sm font-medium text-gray-700">Paket Terjangkau & Transparan</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {packages.map((pkg, i) => (
            ...
            >
              {/* Badge */}
              {pkg.badge && (
                <div className={`absolute -top-3 left-1/2 transform -translate-x-1/2 z-10 px-4 py-1.5 rounded-full text-xs font-semibold shadow-sm ${
                  pkg.recommended 
              ...
              {/* Card */}
              <div className={`h-full flex flex-col p-8 bg-white rounded-2xl transition-all duration-300 ${
                pkg.recommended 
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {pkg.highlights.map((h, idx) => (
                      <span key={idx} className="text-xs px-2.5 py-1 bg-gray-100 text-gray-700 rounded-md">
                        {h}
                      </span>
                    ))}
                  </div>
                  ...
                  <ul className="space-y-3">
                    {pkg.features.map((f, idx) => (
                      <li key={idx} className="flex items-start gap-2.5 text-sm text-gray-700">
                        <Check size={18} className={`flex-shrink-0 mt-0.5 ${pkg.recommended ? 'text-blue-600' : 'text-gray-400'}`} strokeWidth={2.5} />
                        <span>{f}</span>
                      </li>
                    ))}
                  </ul>
                ...
                <a
                  ...
                  className={`flex items-center justify-center gap-2 py-3 px-6 rounded-lg font-semibold text-sm transition-all duration-200 ${
                    pkg.recommended
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="p-6 bg-white rounded-xl border border-gray-200">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Jaminan 100% Uang Kembali</h3>
          ...
          <div className="p-6 bg-white rounded-xl border border-gray-200">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Support Seumur Hidup</h3>
                <p className="text-sm text-gray-600 leading-relaxed">
